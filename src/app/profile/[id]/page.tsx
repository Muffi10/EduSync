...
<div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-8 relative">
  ...
  {/* Profile Info - Below on mobile, right on desktop */}
  <div className="flex-1 text-center md:text-left w-full md:w-auto">
    <div className="flex flex-col items-center md:items-start gap-4 mb-3">
      ...
      {/* Bio */}
      {user.bio && (
        <p className="text-gray-700 dark:text-gray-300 max-w-2xl text-center md:text-left">
          {user.bio}
        </p>
      )}
      ...
      {/* Follow/Unfollow Button - Centered on mobile */}
      ...
      {/* Settings Button - Centered on mobile */}
      {isOwner && (
        <div className="mt-2 w-full max-w-xs mx-auto md:mx-0">
          <button
